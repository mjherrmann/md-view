...
- [x] 1. Create directory traversal module
  - [x] 1.1 Create `src/lib/directoryImport.ts` with `CollectedFile` interface, `isReadableEntry`, and `collectFilesFromDirectory`
  ...
  - [x] 1.2 Write property tests for traversal logic (`src/lib/__tests__/directoryImport.property.test.ts`)
...
- [x] 2. Extend DB layer for directory group operations
  - [x] 2.1 Add `findOrCreateDirectoryGroup` to `src/db/schema.ts`
  ...
  - [x] 2.2 Add `createFilesInGroup` to `src/db/schema.ts`
  ...
  - [x] 2.3 Write property tests for group creation/reuse (`src/db/__tests__/directoryGroup.property.test.ts`)
...
- [x] 4. Modify DropZone to detect and dispatch directories
  - [x] 4.1 Update `src/components/DropZone.tsx` to add `onDirectories` prop and directory detection
  ...
  - [x] 4.2 Write unit tests for DropZone directory detection
...
- [x] 5. Wire directory import flow in App
  - [x] 5.1 Add `onDirectoriesDropped` handler in `src/App.tsx`
  ...
  - [x] 5.2 Write integration property tests (`src/db/__tests__/directoryImportIntegration.property.test.ts`)
